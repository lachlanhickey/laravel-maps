@if ($enabled)
    ...
    @if ($service == 'osm' || $service == 'bing' || $service == 'mapquest')
        <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" integrity="sha256-20nQCchB9co0qIjJZRGuk2/Z9VM+kNiyxNV1lvTlZBo=" crossorigin="" type="text/javascript"></script>
        {{-- TODO check if bing needs polyfill: https://github.com/digidem/leaflet-bing-layer--}}
    @endif
    <script src="{{ asset('vendor/maps/js/index.js') }}" type="text/javascript"></script>
    @if ($service == 'mapkit')
